...
for trial= 1 : Trials_num
    ...
    data.dat.movie_starttime(trial, Run_num) = GetSecs;
    ...
    data.dat.movie_endtime(trial, Run_num) = GetSecs;
    data.dat.movie_duration(trial, Run_num) = data.dat.movie_endtime(trial, Run_num) - data.dat.movie_starttime(trial, Run_num);

    waitsec_fromstarttime(data.dat.trial_starttime(trial, Run_num), wait_after_movie)
